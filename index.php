...
<html>
    ...
    <body>
        ...
        <div class="drag_container" data-cost ="10.00" data-itemId = "124" data-image = "http://livelyworks.net/cc-demo/jQueryPHPStoreDemo/uploads/thumb/camera_on_the_floor-other.jpg?1378372841" style="float: left; width: 100px; height: 100px; background-color: lightgray; margin-right: 10px; margin-bottom: 10px;">
            <div>
                <img src="http://livelyworks.net/cc-demo/jQueryPHPStoreDemo/uploads/thumb/coffee_beans_in_hand-other.jpg?1378379954" style="max-width: 100%;"/>
